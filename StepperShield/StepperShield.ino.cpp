#line 1 "/Users/iMac/Documents/Arduino/StepperShield/StepperShield.ino"
...
AccelStepper stepperX(AccelStepper::DRIVER, 4, 7);
AccelStepper stepperY(AccelStepper::DRIVER, 2, 5);
AccelStepper stepperZ(AccelStepper::DRIVER, 3, 6);
  ...
  case 1:
    {
      ...
      getSerial();
      total_steps = serialdata;
      Serial.println(total_steps);
      moveMotor(total_steps);
      total_steps = 0;
    ...
    case 2:
    {
      Serial.println("Case 1 - reverse");
      getSerial();
      total_steps = serialdata * -1;
      Serial.println(total_steps);
      moveMotor(total_steps);
      total_steps = 0;
      Serial.println("FINISHED");
